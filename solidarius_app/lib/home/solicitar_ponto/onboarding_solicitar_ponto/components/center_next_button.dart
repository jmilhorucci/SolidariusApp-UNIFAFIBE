    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) => Padding(
                ...
                child: Center(
                  child: Container(
                    height: 58,
                    width: 58 + (300 * _signUpMoveAnimation.value),
                    ...
                    child: PageTransitionSwitcher(
                      ...
                      child: _signUpMoveAnimation.value > 0.7
                          ? InkWell(
                              key: ValueKey('Acessar Formulario'),
                              onTap: onNextClick,
                              child: Padding(
                                padding:
          ...
          //                     TextSpan(
          //                         text: 'Ao prosseguir, estará de acordo com os ',
          //                         style: TextStyle(
          ...
          //                     TextSpan(
          //                         text:
          //                             ' do aplicativo.\nPara saber mais, acesse: Home > menu lateral esquerdo > opção "Sobre".',
          //                         style: TextStyle(
          //                           overflow: TextOverflow.ellipsis,
          //                           fontWeight: FontWeight.normal,
          //                           fontSize: 10,
