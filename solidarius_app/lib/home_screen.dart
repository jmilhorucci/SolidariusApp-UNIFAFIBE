...
import 'package:solidarius_app/common/sem_conexao_screen.dart';
import 'package:solidarius_app/model/homelist.dart';
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  void registrarUsuarioApi() async {
    var conseguiuLogarAoAbrirapp = false;
    if (await InternetConnectionChecker().hasConnection) {
      var usuarioApi = await autenticarApi();
      conseguiuLogarAoAbrirapp = true;
      GetIt.I.registerSingleton<UsuarioApi>(usuarioApi);
    }
    GetIt.I.registerSingleton<bool>(conseguiuLogarAoAbrirapp);
  }

  void testarApi() async {
    var instituicoes =
        await baseService.obterInstituicoesCadastroAprovado(usuarioApi);
  }
